...
test.beforeEach(async ({ page }) => {
  // Also mark the demo deck as already seeded so this test sees a genuinely
  // empty dashboard rather than the auto-created sample deck real first-time
  // visitors get (see seedDemoPresentationIfFirstRun in src/lib/storage.ts).
