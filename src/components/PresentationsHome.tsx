  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={onCancel}>
      <div
        ...
        className="bg-[#fdf8f4] border border-stone-200 rounded-lg shadow-xl shadow-stone-300/40 p-5 w-80 max-w-[calc(100vw-2rem)]"
        onClick={(e) => e.stopPropagation()}
      >
        <p id="template-dialog-title" className="text-sm font-semibold text-stone-800 mb-1">
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={onClose}>
      <div
        ...
        className="bg-[#fdf8f4] border border-stone-200 rounded-lg shadow-xl shadow-stone-300/40 p-5 w-96 max-w-[calc(100vw-2rem)] max-h-[70vh] flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between mb-1">
          <p id="trash-dialog-title" className="text-sm font-semibold text-stone-800">Trash</p>
          <button
            onClick={onClose}
            aria-label="Close"
