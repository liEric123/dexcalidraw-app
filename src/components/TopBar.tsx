  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className={`w-8 h-8 flex items-center justify-center rounded-lg text-stone-500 hover:text-stone-700 hover:bg-stone-100 transition-colors ${open ? "bg-stone-100 text-stone-700" : ""}`}
      >
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-full mt-2 bg-[#fdf8f4] border border-stone-200 rounded-xl shadow-xl shadow-stone-200/60 py-1.5 z-50 min-w-[192px]"
        >
          <button
            role="menuitem"
            onClick={action(onExport)}
            disabled={!isHydrated || isExporting}
            className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-stone-500 hover:text-stone-900 hover:bg-stone-50 transition-colors disabled:opacity-40 disabled:pointer-events-none"
          >
          ...
          <button
            ...
            className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-stone-500 hover:text-stone-900 hover:bg-stone-50 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button
            role="menuitem"
            onClick={action(onImportExcalidraw)}
            className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-stone-500 hover:text-stone-900 hover:bg-stone-50 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button
            role="menuitem"
            onClick={action(onInsertMermaid)}
          ...
          <button
            role="menuitem"
            onClick={action(onImportLibrary)}
            className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-stone-500 hover:text-stone-900 hover:bg-stone-50 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          {libraryItemCount > 0 && (
            <button
              role="menuitem"
              onClick={action(onClearLibrary)}
              className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-red-400 hover:text-red-600 hover:bg-stone-50 transition-colors"
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button
            role="menuitem"
            onClick={action(onToggleTemplate)}
            className="flex items-center gap-2.5 w-full px-3.5 py-2 text-sm text-stone-500 hover:text-stone-900 hover:bg-stone-50 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
