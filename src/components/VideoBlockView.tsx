        ...
        {showMenu && (
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              align="end"
              className="w-44 py-1 rounded-lg bg-neutral-900 border border-white/15 shadow-xl text-neutral-200"
            >
              <DropdownMenuItem
                className="text-xs text-neutral-200 hover:bg-white/10 hover:text-neutral-200 focus:bg-white/10 focus:text-neutral-200"
                onClick={() => {
                  const t = playhead();
              ...
              <DropdownMenuItem
                ...
                onClick={() => onUpdate?.({ breakpoints: toggleBreakpoint(block.breakpoints, playhead()) })}
              >
              ...
              <DropdownMenuItem
                ...
                onClick={() => onUpdate?.({ trimEnd: playhead() })}
              >
                Set trim end here
              </DropdownMenuItem>
              <DropdownMenuItem
                ...
                onClick={() => onUpdate?.({ trimStart: undefined, trimEnd: undefined })}
              >
                Clear trim
              </DropdownMenuItem>
            </DropdownMenuContent>
